/datum/migrant_role/heartfelt/lord
	...
	greet_text = "You are the Lord of Heartfelt, ruler of a once-prosperous barony now in ruin. Guided by your Magos, you journey to Emberstead, seeking aid to restore your domain to its former glory, or perhaps claim a new throne."
...
/datum/migrant_role/heartfelt/lady
	...
	greet_text = "You are the Lady of Heartfelt, once a respected noblewoman now struggling to survive in a desolate landscape. With your home in ruins, you look to Emberstead, hoping to find new purpose or refuge amidst the chaos."
...
/datum/migrant_role/heartfelt/hand
	...
	greet_text = "You are the Hand of Heartfelt, burdened by the perception of failure in protecting your Lord's domain. Despite doubts from others, your loyalty remains steadfast as you journey to Emberstead, determined to fulfill your duties."
...
/datum/migrant_role/heartfelt/knight
	...
	greet_text = "You are a Knight of Heartfelt, once part of a brotherhood in service to your Lord. Now, alone and committed to safeguarding what remains of your court, you ride to Emberstead, resolved to ensure their safe arrival."
...
/datum/migrant_role/heartfelt/magos
	...
	greet_text = "You are the Magos of Heartfelt, renowned for your arcane knowledge yet unable to foresee the tragedy that befell your home. Drawn by a guiding star to Emberstead, you seek answers and perhaps a new purpose in the wake of destruction."
...
/datum/migrant_role/heartfelt/prior
	...
	greet_text = "The Prior of Heartfelt, you were destined for ascension within the Church, but fate intervened with the barony's downfall, delaying it indefinitely. Still guided by the blessings of Heliora, you journey to Emberstead, determined to offer what aid and solace you can."
