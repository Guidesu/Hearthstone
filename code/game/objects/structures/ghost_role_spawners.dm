...
/obj/effect/mob_spawn/human/exile/special(mob/living/new_spawn)
	...
	switch(wish)
		...
		if(3)
			to_chat(new_spawn, "<b>I wished for power. Little good it did you, cast out of the light. You are the [gender == MALE ? "leader" : "queen"] of a hell that holds no subjects. You feel only remorse.</b>")
		if(4)
